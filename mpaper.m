...
%disp(varargin)
%disp(class(varargin{2}))
if isnumeric(varargin{2})
    classifierType = varargin{2};
else
    classifierType = varargin{4};
end
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
if nargin >= 2 && (ischar(varargin{1}) || isa(varargin{1}, 'matlab.ui.Figure')),
  ...
  switch cmd,
    case 'Dn', Dn(classifierType);
    case 'Up', Up(classifierType);
    case 'Plot', Plot();
  end
else
   
  if nargin >=2 && varargin{1} ~= "" && ~isa(varargin{1}, 'matlab.ui.Figure'), options = c2s(varargin{1}); else options=[]; end
  ...
  figure;
  set( gcf, 'WindowButtonDownFcn', {@mpaper, 'Dn', classifierType});%'mpaper(''Dn'')' );
  Cla;
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
function Up(classifierType, varargin)
...
%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: 
function Dn(classifierType, varargin)
      switch get(gcf, 'SelectionType')   % clicked mouse button
          
       case 'normal'  % left    if click in the left mouse button
          setappdata(gcf, 'last', [] );
          set( gcf, 'WindowButtonMotionFcn', {@mpaper, 'Plot', classifierType});%'mpaper(''Plot'')' );
          set( gcf, 'WindowButtonUpFcn', {@mpaper, 'Up', classifierType});%'mpaper(''Up'')' );
          Plot
 ...
 % line feval:
 %
 disp("ClassifierType is: "); disp(classifierType);
              feval(options.fun, data, classifierType);
